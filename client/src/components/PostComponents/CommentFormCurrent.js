...
import { addCurrentComment } from '../../actions/post';

const CommentFormCurrent = ({ postId, addCurrentComment }) => {
    ...
    return(
        ...
        onSubmit={e => {
            e.preventDefault()
            addCurrentComment(postId, formData)
...
export default connect(null, { addCurrentComment })(CommentFormCurrent)
