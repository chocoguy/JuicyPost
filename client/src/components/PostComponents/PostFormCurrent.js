...
import { addCurrentPost } from '../../actions/post';

const PostFormCurrent = ({ addCurrentPost }) => {
...
export default connect(null, { addCurrentPost })(PostFormCurrent)