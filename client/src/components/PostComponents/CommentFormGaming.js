...
import { addGamingComment } from '../../actions/post';

const CommentFormGaming = ({ postId, addGamingComment }) => {
    ...
    return(
        ...
        onSubmit={e => {
            e.preventDefault()
            addGamingComment(postId, formData)
...
export default connect(null, { addGamingComment })(CommentFormGaming)
