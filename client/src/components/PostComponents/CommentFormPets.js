...
import { addPetComment } from '../../actions/post';

const CommentFormPets = ({ postId, addPetComment }) => {
...
export default connect(null, { addPetComment })(CommentFormPets)
