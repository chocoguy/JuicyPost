...
import { addGamingPost } from '../../actions/post';

const PostFormGaming = ({ addGamingPost }) => {
...
export default connect(null, { addGamingPost })(PostFormGaming)