...
import { addAnimeComment } from '../../actions/post';

const CommentFormAnime = ({ postId, addAnimeComment }) => {
    ...
    return(
        ...
        onSubmit={e => {
            e.preventDefault()
            addAnimeComment(postId, formData)
...
export default connect(null, { addAnimeComment })(CommentFormAnime)
