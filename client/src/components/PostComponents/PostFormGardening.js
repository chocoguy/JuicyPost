...
import { addGardeningPost } from '../../actions/post';

const PostFormGardening = ({ addGardeningPost }) => {
...
export default connect(null, { addGardeningPost })(PostFormGardening)