...
import { addGardeningComment } from '../../actions/post';

const CommentFormGardening = ({ postId, addGardeningComment }) => {
    ...
    return(
        ...
        onSubmit={e => {
            e.preventDefault()
            addGardeningComment(postId, formData)
...
export default connect(null, { addGardeningComment })(CommentFormGardening)
