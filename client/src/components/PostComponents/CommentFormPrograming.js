...
import { addProgramingComment } from '../../actions/post';

const CommentFormPrograming = ({ postId, addProgramingComment }) => {
    ...
    return(
        ...
        onSubmit={e => {
            e.preventDefault()
            addProgramingComment(postId, formData)
...
export default connect(null, { addProgramingComment })(CommentFormPrograming)
